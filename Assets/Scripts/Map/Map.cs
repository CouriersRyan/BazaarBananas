...
{
    [SerializeField] private GameObject nodePrefab; // The prefab that gets instantiated to represent a node in the Scene.
    ...
    private Delaunator _delaunator; // Holds the triangulation and connection between the nodes on the map.
    ...
    // Creates a map and paths from the southmost to northmost node multiple times.
    void Awake()
    {
        GenerateMap();
     ...
     *
     * Almost all functions have been modified to some extent, though it's hard to point out exactly where I modified
     * each function. I marked any function that were fully implemented by me as new ones.
     *
    ...
    // Creates empty objects to act as parents on gameobjects generated by this class.
    ...
    // *New function*
    // Returns the node with the lowest Y position.
    ...
    // *New function*
    // Returns the node with the highest Y position.
    ...
    //*This is almost entirely new code I made myself.*
